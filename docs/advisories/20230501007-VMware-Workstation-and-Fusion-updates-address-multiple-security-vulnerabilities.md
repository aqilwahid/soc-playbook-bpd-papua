...
The Bank Papua SOC has observed multiple security vulnerabilities in VMware Workstation and Fusion. Updates and workarounds are available to remediate these vulnerabilities in the affected VMware products.
...
The Bank Papua SOC recommends administrators apply the solutions as per vendor instructions to all affected devices where possible: [VMware Security Advisory](https://www.vmware.com/security/advisories/VMSA-2023-0008.html)
