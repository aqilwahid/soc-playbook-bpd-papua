...
## Bank Papua SOC - Recent Threat Activity (August 2025)

Based on recent high impact incidents seen by the Bank Papua SOC, security teams should be focusing on the below areas of improvement based on phishing and phishing resistant MFA:

!!! warning "Bank Papua SOC Guidance targeted on recent escalation of state-based actor threat activity"
...
Recent Bank Papua SOC advisories this month worth staying across include:
